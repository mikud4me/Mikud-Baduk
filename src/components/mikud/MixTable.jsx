...
const MIX_META = {
  recommended: {
    icon: Sparkles,
    strategy: 'תמהיל מאוזן — הגנה + הזדמנות',
    rationale: 'שילוב אופטימלי בין יציבות לחיסכון. שליש בפריים מנצל ריביות נמוכות, שליש בקל"צ מגן מעליות, ושליש במשתנה צמודה מאזן את הסיכון.',
    pros: ['חשיפה לירידות ריבית עתידיות', 'הגנה מפני עליות פתאומיות', 'אופטימלי לפי תקני בנק ישראל'],
    cons: ['החזר עשוי להשתנות מעט עם הזמן'],
